 ...
 *             还能直接打开某一版、在文件夹里定位它，并把「还没进记录」的产物收编成一版
...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		exports.__internals = { WorkbenchIcon, WorkbenchPanel, RightDockPage, SkillsTab, DocsTab, IterationTab, DirectoryDialog, detectScheme, sourceLabel, STATE_META, kindMeta, approvalMeta, pickDirectory, serviceOf, chooseDirectory, backToConversation, openInRightColumn, registerRightColumn, RIGHT_TAB_KIND, __debugReportPending }
